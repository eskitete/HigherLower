...
const NFLGame: React.FC = () => {
  ...
  const handleScoreSubmit = async () => {
    ...
    try {
      ...
      localStorage.setItem(`nflTrivia_submitted_max_streak_${leaderboardDiff}`, streakToSubmit.toString());
                    ...
                    <div className="space-y-4">
                      ...
                      {score[leaderboardDiff].maxStreak > 0 && (
                        <div className="pt-4 border-t border-white/10 space-y-3">
                          ...
                          {Number(localStorage.getItem(`nflTrivia_submitted_max_streak_${leaderboardDiff}`) || 0) < score[leaderboardDiff].maxStreak ? (
